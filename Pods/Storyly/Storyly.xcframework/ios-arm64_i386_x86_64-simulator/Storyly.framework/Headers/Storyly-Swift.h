...
///
- (nonnull instancetype)initWithId:(NSInteger)id index:(NSInteger)index title:(NSString * _Nonnull)title seen:(BOOL)seen media:(StoryMedia * _Nonnull)media OBJC_DESIGNATED_INITIALIZER;
...
///
- (nonnull instancetype)initWithId:(NSInteger)id title:(NSString * _Nonnull)title iconUrl:(NSURL * _Nonnull)iconUrl index:(NSInteger)index seen:(BOOL)seen stories:(NSArray<Story *> * _Nonnull)stories OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// XLarge group size which has a story group text that is aligned with bottom of the icon
  StoryGroupSizeXLarge = 2,
/// Custom group size which has customizable features
  StoryGroupSizeCustom = 3,
};
...
///
- (nonnull instancetype)initWithIsVisible:(BOOL)isVisible OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
- (nonnull instancetype)initWithIsTextVisible:(BOOL)isTextVisible isIconVisible:(BOOL)isIconVisible isCloseButtonVisible:(BOOL)isCloseButtonVisible OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
- (nonnull instancetype)initWithType:(enum StoryType)type actionUrlList:(NSArray<NSString *> * _Nullable)actionUrlList actionUrl:(NSString * _Nullable)actionUrl OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// This property allows you to change the gradient colors behind the story
/// group text if group size is set to XLarge
@property (nonatomic, copy) IBInspectable NSArray<UIColor *> * _Nonnull storyGroupIconForegroundColors;
